...
def lambda_handler(event, context):
    sns_topic_arn = 'arn:aws:sns:us-east-1:730335436455:automatic-file-notification-system-topic'

    # Define the SQS queue URL
    sqs_queue_url = 'https://sqs.us-east-1.amazonaws.com/730335436455/automatic-file-notification-queue'
